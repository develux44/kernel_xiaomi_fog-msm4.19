deps_config := \
	...
	drivers/usb/typec/wusb3801x/Kconfig \
	...
	drivers/power/supply/battery_secret/Kconfig \
	drivers/power/supply/nopmi/Kconfig \
	...
	drivers/input/touchscreen/ft8006s_spi/Kconfig \
	...
	drivers/input/touchscreen/nt36525b_spi/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "Android (10087095, +pgo, +bolt, +lto, -mlgo, based on r487747c) clang version 17.0.2 (https://android.googlesource.com/toolchain/llvm-project d9f89f4d16663d5012e5c09495f3b30ece3d2362)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "ccache clang --target=aarch64 -march=armv8-a+crc+crypto -mcpu=cortex-a73+crc+crypto -mtune=cortex-a73 -funroll-loops -O3"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ld.lld"
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/WORKSPACE/kernel_xiaomi_fog-msm4.19/aarch64-linux-android-4.9/bin/aarch64-linux-android- --gcc-toolchain=/WORKSPACE/kernel_xiaomi_fog-msm4.19/aarch64-linux-android-4.9  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
